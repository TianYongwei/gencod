...
public class VelocityUtils
{
    ...
    private static final String GENSQL_PATH = "main/resources/gensql";
     ...
     * 获取文件名
     */
    public static String getFullFileName(String template, GenTable genTable)
    {
        // 文件名称
        String fileName = "";
        // 包路径
        ...
        String javaPath = System.getProperty("user.dir") + "/src/" + PROJECT_PATH + "/" + StringUtils.replace(packageName, ".", "/");
        String mybatisPath = System.getProperty("user.dir") + "/src/" + MYBATIS_PATH + "/" + moduleName;
        String gensqlPath = System.getProperty("user.dir") + "/src/" + GENSQL_PATH;
        String htmlPath = System.getProperty("user.dir") + "/src/" + TEMPLATES_PATH + "/" + moduleName + "/" + businessName;
        ...
        {
            fileName = StringUtils.format("{}/{}Menu.sql", gensqlPath, businessName);
        }
        return fileName;
    }
