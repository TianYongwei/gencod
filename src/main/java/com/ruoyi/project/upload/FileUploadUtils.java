...
public class FileUploadUtils
{
            ...
            throws FileSizeLimitExceededException, IOException, FileNameLengthLimitExceededException
    {
        ...
        {
            throw new FileNameLengthLimitExceededException(fileNamelength);
        }
     ...
     * @throws IOException
     */
    public static final String upload_dir(String baseDir, MultipartFile file) throws IOException
    {
        try
        {
            return upload_dir(baseDir, file, FileUploadUtils.IMAGE_JPG_EXTENSION);
        }
        catch (Exception e)
        {
            throw new IOException(e);
     ...
     * @throws IOException 比如读写文件出错时
     */
    public static final String upload_dir(String baseDir, MultipartFile file, String extension)
            throws FileSizeLimitExceededException, IOException, FileNameLengthLimitExceededException
    {
        ...
        String[] pathTemp = getDir(baseDir);
        
        File desc = getAbsoluteFile(pathTemp[0], pathTemp[0] + fileName);
        file.transferTo(desc);
        System.out.println("上传成功,文件名称："+pathTemp[1] + fileName);
        return pathTemp[1] + fileName;
    }
    //获取路径
